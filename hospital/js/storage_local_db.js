...
var m1provider = document.getElementById("m1provider");
var m1qu = document.getElementById("m1qu");
...
//Delete Button
var delete_button = document.getElementById("delete1");
delete_button.addEventListener("click", function () { mydelete1(this.value); });
...
function mydelete1(s) {
    var arr2 = {};
    arr2.inv_id = delete_button.value;
