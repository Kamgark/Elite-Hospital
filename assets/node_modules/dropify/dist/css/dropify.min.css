...
.dropify-wrapper .dropify-preview .dropify-render img{
    ...
    max-width:100%;
    max-height:100%;
    background-color:#FFF;-webkit-transition:border-color .15s linear;
    transition:border-color .15s linear
}
